...
$theme_config = array(
    ...
    'bo_gallery_height'             => 305,     // 갤러리 이미지 높이
    ...
    'de_mobile_search_img_width'    => 30.,     // 모바일 관련상품 이미지 폭
	...
	'theme_bn_order'                => 34,       // 테마 데모에서 테마별 보여줄 bn_order 값
    'theme_event_id'                => '1554944437,1554944406' // 테마 이벤트 ID
);
...
if( ! function_exists('buzinga54_add_theme_admin_menu') ){
	// 관리자 메뉴 추가
	add_replace('admin_menu', 'buzinga54_add_theme_admin_menu', 1, 1);

	function buzinga54_add_theme_admin_menu($admin_menu){

		if( isset($admin_menu['menu100']) ){
			array_push($admin_menu['menu100'], array('100281', 'blanc 테마 관리', G5_THEME_ADM_URL, 'shop_item_import'));
		}
